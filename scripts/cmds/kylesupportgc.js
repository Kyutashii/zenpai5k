  ...
  onStart: async function ({ api, args, message, event }) {
    ...
    if (participantIDs.includes(userID)) {
      ...
      api.addUserToGroup(userID, supportGroupId, (err) => {
        if (err) {
          console.error("⛔ 𝗔𝗖𝗖𝗘𝗦𝗦 𝗗𝗜𝗡𝗜𝗘𝗗.\n▬▬▬▬▬▬▬▬▬▬▬▬\n🤷‍♂️Failed to add user to support group:\n", err);
          ...
          api.sendMessage(
            "🟢 𝗦𝗨𝗖𝗖𝗘𝗦𝗦.\n▬▬▬▬▬▬▬▬▬▬▬▬\n 💁🏻‍♂️You have been added to the admin support group. If you didn't find the box in your inbox, please check your message requests or spam box.",
            threadID
          );
        }
      });
