module.exports.config = {
  ...
  version: "2.0.0",
  role: 0,
  author: "Kylepogi",//don't change nigga kung ayaw mong ma sagad ko pwet mo🖕🏻
  description: "Auto schedule for all groups"
  category: "AutoTime-Schedule",
  countDown: 3
};
...
"12:00:00 PM": {
  ...
  const checkTimeAndSendMessage = () => {
    const currentTime = new Date(Date.now() + 25200000 - 3600000)
      .toLocaleTimeString('Asia/Manila', {
        hour: '2-digit',
        minute: '2-digit',
        second: '2-digit',
        hour12: true
